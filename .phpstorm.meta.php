...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/mtake/php_projects/snalara/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/mtake/php_projects/snalara/public/storage','ide-helper.filename','ide-helper.models_filename',
...
'queue.failed.driver','queue.failed.database','queue.failed.table','schedule-monitor.delete_log_items_older_than_days','schedule-monitor.date_format',
...
'schedule-monitor.oh_dear.api_url','services.postmark.token','services.ses.key','services.ses.secret','services.ses.region',
...
'sitemap.crawl_profile','cors.paths','cors.allowed_methods','cors.allowed_origins','cors.allowed_origins_patterns',
...
'inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','tinker.commands','tinker.alias',
'tinker.dont_alias',);
